...
import { extractToTranslationForFile, extractToTranslationForGeneral, extractToTranslationForCustomKey, regenerateTranslationKeys } from './commands/extract-to-translation-file';
...
export function activate(context: vscode.ExtensionContext)
{
  ...
  context.subscriptions.push(
    ...
    vscode.commands.registerCommand(`${Values.pluginId}.extractToTranslationForCustomKey`, extractToTranslationForCustomKey),
    vscode.commands.registerCommand(`${Values.pluginId}.regenerateTranslationKeys`, regenerateTranslationKeys),
